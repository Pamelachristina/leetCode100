...
LinkedList.prototype.deleteVal = function(value) {
  ...
  //if first node's is the node to be deleted, deleted it and return true
  ...
  while(currentNode.nextElement != null){
      //if a node whose next node has the value as data, is found, delete it fromthe list and return true
